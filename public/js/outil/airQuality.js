...
async function getPollutionData() {
  try {
    const response = await fetch("http://api.airvisual.com/v2/nearest_city?key=faeff562-d43d-4787-8c08-a47e9346b29c").catch(error => {
    ...
    emojiLogo.src = "../../../img/airQuality/brower.svg";
...
function populateUI(data){
  console.log(data);
  emojiLogo.src = `../../img/airQuality/${data.src}.svg`;
  userInformation.textContent = `Voici la situation a ${data.city} .`;
